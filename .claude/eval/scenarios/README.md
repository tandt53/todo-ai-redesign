...
| **R7** | The return contract disagreeing across its three parties: the agents that emit it, `ORCHESTRATION.md` that routes on it, and `capture-agent-metrics.js` that parses it. |
