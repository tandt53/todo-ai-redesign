...
**Contains:**
- **Reviewer writes `reports/review-F-*.md`** → extract PASS/FAIL, C1-C14 results, failure details
...
```yaml
custom:
  checks_run: {n}                      # should be 14 (C1-C14)
  checks_passed: {n}
  checks_failed: {n}
...
│   │   └── checks.json                 ← expected reviewer C1-C14 results
