...
- **Phrase list (closed, shared constant `UNDO_PHRASES`):** exactly `"undo"`
  ...
  Growing **or shrinking** the list is a design/product decision; the
...
*"Growing the list is a design/product decision; the mechanism doesn't
...
- `specs/assistant/api-contracts.md` processing rule 3 (voice-undo guard) —
