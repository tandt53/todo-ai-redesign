...
**Status**: `draft` (revision 3 — final Gate 1 revision, `reports/gate1-review-F-001.md ## Round 2 results`; round cap reached. **AC-30 added 2026-08-17, post-Gate-1**, from the owner decision resolving BUG-004 — `reports/owner-decision-2026-08-17-new-message-affordance.md`; no existing AC was reworded. Amended the same day with clause (h) — the owner's answer to Open Question 8, which is now closed against the decision.)
