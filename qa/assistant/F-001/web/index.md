...
**Authored:** 2026-08-16 by qa-web-agent (T-007, phase: author) · **Executed:** 2026-08-16 by qa-web-agent (T-007e, phase: execute) · **Re-executed:** 2026-08-16 by qa-web-agent (T-016, phase: execute v2 — Vietnamese copy sync + WCAG 4.1.3) · **Re-executed:** 2026-08-17 by qa-web-agent (T-070b, phase: execute v3 — ADR-008 English copy sync) · **Spec:** `specs/assistant/F-001-voice-assistant-view.md` rev 3 · **Mockup:** `design/assistant/screens/voice-assistant-view.html` (22 testids, 17 states)
**Automation:** `qa/assistant/automation/e2e/F-001-voice-assistant-view.spec.ts` (50 tests) + `qa/assistant/automation/pages/AssistantPage.ts` — **49/50 PASS**, run via `npm run test:e2e`. The one failure is **TC-047 / BUG-006**, a product defect in AC-30(h); the 36 pre-AC-30 tests are all green.
...
**Run records:** `qa/assistant/runs/2026-08-17-web-ac30.md` (AC-30 — tier split, BUG-006, four script bugs, falsifiability checks, T-079 handling) · `qa/assistant/runs/2026-08-16-web-execute.md` (first execute pass) · `qa/assistant/runs/2026-08-16-web-execute-v2.md` (T-016 copy sync + 4.1.3, mutation checks, drift notes, zero product bugs filed) · `qa/assistant/runs/2026-08-17-web-execute-v3.md` (T-070b English copy sync — before/after numbers, the stale-harness contamination finding, and the green-but-impossible fixtures found outside this scope).
...
`design/_shared/components.md` and `design/_shared/tokens.json` at run time
