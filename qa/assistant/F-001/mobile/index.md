...
`specs/assistant/F-001-voice-assistant-view.md` rev 3, AC-30 (added post-Gate-1 from
`reports/owner-decision-2026-08-17-new-message-affordance.md`, amended the same day with
clause (h)) · **Design:** `design/_shared/components.md § NewMessageAffordance` ·
**Mockups:** `design/assistant/screens/voice-assistant-view-{ios,android}.html`
...
F-003 side (`qa/assistant/F-003/mobile/`), which carries the mobile parity block.
...
|---|---|---|
| the at-bottom threshold (48) | `specs/assistant/F-001-...md` AC-30 (a) | `` `distance_from_bottom ≤ N` `` |
| NMA-HIDDEN / NMA-NEW / NMA-WAITING labels | `design/_shared/components.md` § NewMessageAffordance | the row's Label cell |
