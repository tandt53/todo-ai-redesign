...
| Failing test case | docs/qa/assistant/F-001/web/TC-047-own-send-scrolls-to-bottom.md |
| Status | open |
...
## Environment
- Run ID: `docs/qa/assistant/runs/2026-08-17-web-ac30.md`
...
- **qa-mobile-agent:** AC-30 is tagged `(web, mobile)` and clause (h) shipped on both
  ...
  (`docs/qa/assistant/runs/2026-08-17-mobile-ac30.md`) ran at the **model tier with no
