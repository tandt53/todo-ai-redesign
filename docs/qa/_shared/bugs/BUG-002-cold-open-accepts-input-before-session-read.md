...
| Failing test case | `docs/qa/assistant/F-003/mobile/TC-030-foreground-reads-session-before-accepting-input.md` |
...
- Run ID: `docs/qa/assistant/runs/2026-08-17-mobile-execute.md`
- Command: `npx vitest run tests/assistant/mobile`
- Stack: TypeScript strict + vitest, node env, no simulator (`docs/specs/_shared/platform/mobile.md ## Test Harness`)
