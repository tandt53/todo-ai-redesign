...
**Automation draft:** `tests/assistant/api/F-001-voice-assistant-view.spec.ts` (vitest + supertest in-process, per `docs/specs/_shared/platform/backend.md`).
...
**Test data namespace:** task titles `qaapi-*`; reserved user uuids in `docs/qa/_shared/fixtures/api/users.json` (QAAPI-U1/U2/U3). No unscoped destructive operations.
