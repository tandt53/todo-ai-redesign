...
**Authored:** 2026-08-16 (T-020, `phase: author`) · **Executed:** 2026-08-17 (T-021, `phase: execute`) — both by qa-mobile-agent · **Spec:** `docs/specs/assistant/F-003-mobile-surface.md` rev 1 · **Parity source:** `docs/specs/assistant/F-001-voice-assistant-view.md` rev 3
**Mockups:** `docs/design/assistant/screens/voice-assistant-view-ios.html` + `-android.html` (22 ids, 17 states, copy in Vietnamese)
...
**Fixtures:** `docs/qa/_shared/fixtures/mobile/F-003-mobile-fixtures.json` · **Namespace:** `qamob-` (users `qamob-tc{nnn}@qa.example.com`)
...
**Run:** 2026-08-17 (T-021, `phase: execute`) · **Record:** `docs/qa/assistant/runs/2026-08-17-mobile-execute.md`
...
to architect:** add it to `docs/specs/_shared/platform/mobile.md`'s port list so it is
...
Filed this run: `docs/qa/_shared/bugs/BUG-002-cold-open-accepts-input-before-session-read.md`
...
in `docs/design/_shared/components.md`, which F-001's Naming convention makes the
...
`docs/design/_shared/components.md`. Seeded task titles are fixture data, not copy,
...
`docs/qa/assistant/F-001/api/utterance-intent-fixtures.json`, never copied — the suite
