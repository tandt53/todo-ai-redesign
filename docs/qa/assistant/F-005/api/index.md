...
`docs/specs/assistant/data-model.md § Feature F-005` and ADR-010 … ADR-015 only.
...
`docs/specs/_shared/platform/backend.md ## Test Harness`).
...
clock in [`docs/qa/_shared/fixtures/api/f005-users.json`](../../../_shared/fixtures/api/f005-users.json).
