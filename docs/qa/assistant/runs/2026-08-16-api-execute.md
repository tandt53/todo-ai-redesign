...
3. **Interpreter**: replaced the title-keyed shim with `QaFixtureInterpreter`,
   ...
   `docs/qa/assistant/F-001/api/utterance-intent-fixtures.json` documents — that
...
derives only from `docs/specs/assistant/{F-001-voice-assistant-view,api-contracts,
...
`docs/qa/assistant/F-001/api/TC-10-serial-order-and-answer-binding.md` and
...
authoring — see `docs/qa/assistant/F-001/api/index.md`.
