...
| `docs/qa/assistant/F-001/web/*.md` | 19 TC files re-quoted to the shipped copy; 2 new TC files (TC-033, TC-034); `index.md` updated (34 TCs, 36 tests, AC-19 map, copy-language note) |
