...
- Every endpoint shape comes from `docs/specs/assistant/api-contracts.md` —
  never invented (ethos §9). Entity shapes from `docs/specs/assistant/data-model.md`.
...
Shapes are `docs/specs/assistant/api-contracts.md § Feature F-005`; fields are
