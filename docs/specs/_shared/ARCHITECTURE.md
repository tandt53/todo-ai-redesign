...
`docs/specs/assistant/api-contracts.md` and `data-model.md`, imported by all three.
...
prototype task CRUD (`/tasks…`) — shapes in `docs/specs/assistant/api-contracts.md`.
...
client stores — in `docs/specs/assistant/data-model.md`.
