...
FLOWS = [
    ('M1', 'Lần chạy đầu — app chưa có việc nào',
     ...
     [('talk-idle-empty', 'Màn Talk khi chưa có gì'),
      ('tasks-idle-empty', 'Danh sách việc khi chưa có gì')]),
    ('M2', 'Nói ra một việc',
    ...
    ('M3', 'Danh sách việc',
     ...
     [('talk-idle-tasks', 'Màn Talk khi đã có việc'),
      ('tasks-idle-tasks', 'Danh sách việc'),
      ('drawer-idle-tasks', 'Ngăn kéo Lists')]),
    ...
    ('M5', 'Xoá và hoàn tác',
     ...
     [('talk-applied-delete', 'Đã xoá'),
      ...
      ('tasks-applied-delete', 'Danh sách sau khi xoá'),
      ('drawer-applied-delete', 'Ngăn kéo sau khi xoá')]),
